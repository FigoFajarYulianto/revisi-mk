            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="custom-table card shadow mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a href="#" class="dropdown-item text-dark" data-toggle="modal"
                                        data-target="#popupKategori">Kategori</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- popup kategori -->
                        <!-- modal kategori -->
                        <div class="modal fade" id="popupKategori" data-backdrop="static" data-keyboard="false"
                            tabindex="-1" aria-labelledby="popupKategoriLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="formTambahKategori" action="../admin-dashboard/ajax/ajax-kategori.php"
                                            method="POST">
                                            <div class="d-flex justify-content-between mb-3">
                                                <input required style="width:82%;" type="text"
                                                    name="inputTambahKategori" id="inputKategori" class="form-control"
                                                    placeholder="Masukkan kategori baru...">
                                                <button name="tambahKategori" type="submit"
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody id="tbodyKategori">
                                                ...
                                                <form method="GET" id="formHapusKategori"
                                                    action="ajax/ajax-hapus-kategori.php">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="edit-produk.php?id=<?= $data['id_produk']; ?>">
                                                            <span class="mr-1">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                            <span>Edit</span>
                                                        </a>
                                                        <a onclick="return confirm('Konfirmasi hapus, apakah anda ingin menghapus produk ini?')"
                                                            class="dropdown-item"
                                                            href="hapus-produk.php?id=<?= $data['id_produk']; ?>">
                                                            <span class="mr-1">
                                            ...
                                            <td class="align-middle">
                                                <div class="custom-img-size">
                                                    <div class="embed-responsive embed-responsive-16by9">
                                                        <img alt="product-image" class="embed-responsive-item img-fit"
                                                            src="img/produk/<?= htmlspecialchars($data['image']); ?>" />
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <small>
                                                    <a href="#" data-toggle="popover" data-trigger="focus"
                                                        data-placement="top"
                                                        data-content="<?= ucfirst(htmlspecialchars($desc)); ?>"> <span
                                                            class="font-weight-bold">(Deskripsi)</span></a>
                                                </small>
                                            </td>
                                            <td>
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text bg-light">
                                                        <?= htmlspecialchars($data['stok']); ?></div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="custom-harga">
                                                    <div class="input-group ">
                                                        ...
                                                        <input disabled type="text" class="form-control bg-white"
                                                            value="<?= htmlspecialchars(number_format($data['harga'], 0, '', ".")); ?>">
                                                    </div>
                                                </div>
                                            </td>
    ...
    $(document).ready(function() {
        ...
        function simpanEdit() {
            $(".btnSaveEdit").click(function(event) {
                ...
                $.get("ajax/ajax-edit-kategori.php?id=" + idKategori + "&kategori=" + kategoriBaru,
                    function(data) {
                        tampilData();
                    });
            });
        ...
        function editKategori() {
            $(".btnEditKategori").click(function(event) {
                ...
                $("#formHapusKategori").removeAttr("action").attr("action",
                    "ajax/ajax-edit-kategori.php");
                ...
                batal.click(function() {
                    ...
                    $("#formEditKategori").removeAttr("action").attr("action",
                        "ajax/ajax-hapus-kategori.php");
