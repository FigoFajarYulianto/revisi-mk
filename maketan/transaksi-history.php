                ...
                <div class="card">
                    <div class="card-body py-0 px-0">
                        <div class="tabContainer">
                            ...
                            <div class="tabPanel">
                                <?php
                                    $sql_belum_bayar = "select * from transaksi where user_id=$id_user and status='belum bayar'";
                                    $query_belum_bayar = mysqli_query($koneksi, $sql_belum_bayar);
                                    ...
                                    ?>
                                            ...
                                            <div class="item-trans">
                                                ...
                                                <div class="item-trans-tengah">
                                                        <?php
                                                            $sql_detail_bb = "select * from detail_transaksi inner join tb_produk on detail_transaksi.id_produk = tb_produk.id_produk where id_transaksi=$id_transaksi_bb";
                                                            $query_detail_bb = mysqli_query($koneksi, $sql_detail_bb);
                                                            $total = 0;
                                                                ...
                                                                <div class="item-trans-barang">  
                                                                    <div class="row">
                                                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 text-right">
                                                                            <img src="produk2/produk2/assets/img/produk/<?php echo $data_detail_bb['gbr_produk']; ?>">
                                                                        </div>
                                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 text-left">
                                                                            <span class="trans-nama"><?php echo $data_detail_bb["nama_produk"]; ?></span><br>
                            ...
                            <div class="tabPanel">
                                <?php
                                    $sql_dikemas = "select id_transaksi from transaksi where user_id=$id_user and status='menunggu kirim'";
                                    $query_dikemas = mysqli_query($koneksi, $sql_dikemas);
                                ...
                                <?php
                                    ...
                                    ?>
                                            ...
                                            <div class="item-trans">
                                                ...
                                                <div class="item-trans-tengah">
                                                        <?php
                                                            $sql_detail_dikemas = "select * from detail_transaksi inner join tb_produk on detail_transaksi.id_produk = tb_produk.id_produk where id_transaksi=$id_transaksi_dikemas";
                                                            $query_detail_dikemas = mysqli_query($koneksi, $sql_detail_dikemas);
                                                            $total = 0;
                                                        ...
                                                        ?>
                                                                <div class="item-trans-barang">  
                                                                    <div class="row">
                                                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 text-right">
                                                                            <img src="produk2/produk2/assets/img/produk/<?php echo $data_detail_dikemas['gbr_produk']; ?>">
                                                                        </div>
                                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 text-left">
                                                                            <span class="trans-nama"><?php echo $data_detail_dikemas["nama_produk"]; ?></span><br>
                            ...
                            <div class="tabPanel">
                                <?php
                                    $sql_dikirim = "select id_transaksi, resi from transaksi where user_id=$id_user and status='proses kirim'";
                                    $query_dikirim = mysqli_query($koneksi, $sql_dikirim);
                                ...
                                <?php
                                    ...
                                    ?>
                                            ...
                                            <div class="item-trans">
                                                ...
                                                <div class="item-trans-tengah">
                                                        <?php
                                                            $sql_detail_dikirim = "select * from detail_transaksi inner join produk on detail_transaksi.id_produk = produk.id_produk where id_transaksi=$id_transaksi_dikirim";
                                                            $query_detail_dikirim = mysqli_query($koneksi, $sql_detail_dikirim);
                                                            $total = 0;
                                                        ...
                                                        ?>
                                                                <div class="item-trans-barang">  
                                                                    <div class="row">
                                                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 text-right">
                                                                            <img src="produk2/produk2/assets/img/produk/<?php echo $data_detail_dikirim['gbr_produk']; ?>">
                                                                        </div>
                                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 text-left">
                                                                            <span class="trans-nama"><?php echo $data_detail_dikirim["nama_produk"]; ?></span><br>
                                                                            <
                                                                            < class="trans-jumlah">Jumlah: <?php echo $data_detail_dikirim["jumlah"]; ?></>
                                                                        </div>
                                                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 text-right">
                            ...
                            <div class="tabPanel">
                                <?php
                                    $sql_selesai = "select id_transaksi from transaksi where user_id=$id_user and status='selesai'";
                                    $query_selesai = mysqli_query($koneksi, $sql_selesai);
                                ...
                                <?php
                                    ...
                                    ?>
                                            ...
                                            <div class="item-trans">
                                                ...
                                                <div class="item-trans-tengah">
                                                        <?php
                                                            $sql_detail_selesai = "select * from detail_transaksi inner join produk on detail_transaksi.id_produk = produk.id_produk where id_transaksi=$id_transaksi_selesai";
                                                            $query_detail_selesai = mysqli_query($koneksi, $sql_detail_selesai);
                                                            $total = 0;
                                                        ...
                                                        ?>
                                                                <div class="item-trans-barang">  
                                                                    <div class="row">
                                                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 text-right">
                                                                            <img src="produk2/produk2/assets/img/produk/<?php echo $data_detail_selesai['grb_produk']; ?>">
                                                                        </div>
                                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 text-left">
                                                                            <span class="trans-nama"><?php echo $data_detail_selesai["nama_produk"]; ?></span><br>
                                                                            <br>
                            ...
                            <div class="tabPanel">
                                <?php
                                    $sql_gagal = "select id_transaksi from transaksi where user_id=$id_user and status='gagal'";
                                    $query_gagal = mysqli_query($koneksi, $sql_gagal);
                                ...
                                <?php
                                    ...
                                    ?>
                                            ...
                                            <div class="item-trans">
                                                ...
                                                <div class="item-trans-tengah">
                                                        <?php
                                                            $sql_detail_gagal = "select * from detail_transaksi inner join produk on detail_transaksi.id_produk = produk.id_produk  where id_transaksi=$id_transaksi_gagal";
                                                            $query_detail_gagal = mysqli_query($koneksi, $sql_detail_gagal);
                                                            $total = 0;
                                                        ...
                                                        ?>
                                                                <div class="item-trans-barang">  
                                                                    <div class="row">
                                                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 text-right">
                                                                            <img src="produk2/produk2/assets/img/produk/<?php echo $data_detail_gagal['gbr_produk']; ?>">
                                                                        </div>
                                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 text-left">
                                                                            <span class="trans-nama"><?php echo $data_detail_gagal["nama_produk"]; ?></span><br>
