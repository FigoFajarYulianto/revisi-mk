...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama" class="form-control" required oninvalid="this.setCustomValidity('silahkan masukkan nama produk.')" oninput="setCustomValidity('')" value="<?php echo $pecah['nama_produk']; ?>">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="id_kategori" required oninvalid="this.setCustomValidity('silahkan isi kategori.')" oninput="setCustomValidity('')">
    ...
    <div class="form-group">
        ...
        <input type="number" name="harga_produk" class="form-control" min="1" max="99999999999" required value="<?php echo $pecah['harga']; ?>">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="id_satuan" required oninvalid="this.setCustomValidity('silahkan isi satuan.')" oninput="setCustomValidity('')">
    ...
    <div class="form-group">
        ...
        <input type="text" name="map" class="form-control" required oninvalid="this.setCustomValidity('silahkan masukkan alamat produk.')" oninput="setCustomValidity('')" value="<?php echo $pecah['map_link']; ?>">
    ...
    <div class="form-group">
        ...
        <input type="file" name="foto" class="form-control" required oninvalid="this.setCustomValidity('silahkan isi foto.')" oninput="setCustomValidity('')">
