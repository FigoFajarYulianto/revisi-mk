            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-kategori.php?status=edit&id_kategori=<?php echo $data['id_kategori']; ?>"
                                class="btn btn-link" title="Edit Kategori">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="delete-kategori.php?id_kategori=<?php echo $data['id_kategori']; ?>"
                                class="btn btn-link" title="Hapus Kategori"
