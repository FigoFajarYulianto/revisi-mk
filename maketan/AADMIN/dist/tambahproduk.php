...
?>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="5" required type="number" min="1" name="stok" id="stok" class="form-control"
                        required oninvalid="this.setCustomValidity('isi stok.')" oninput="setCustomValidity('')">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="foto" required="required"
                        oninvalid="this.setCustomValidity('silahkan masukkan foto Produk.')"
                        oninput="setCustomValidity('')">
...

		{
			...
			$koneksi->query("INSERT INTO tb_produk
				...
				(nama_produk,id_kategori, deskripsi_produk,harga,stok,id_satuan,map_link, gbr_produk)

				VALUES('$_POST[nama]','$_POST[id_kategori]','$_POST[deskripsi]','$_POST[harga]','$_POST[stok]','$_POST[id_satuan]','$_POST[map]','$namanamafoto')");
