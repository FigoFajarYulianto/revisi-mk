            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-user.php?status=edit&id_user=<?php echo $data['id_user']; ?>&level=<?php echo $data["level"]; ?>"
                                class="btn btn-link">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="delete-user.php?id_user=<?php echo $data['id_user']; ?>&level=<?php echo $data['level']; ?>"
                                class="btn btn-link" onclick="return confirm('Apakah anda yakin ingin menghapusnya?')">
                    ...
                    <ul class="pagination justify-content-end">
                        ...
                        <?php
                                ...
                                for($i=1; $i<=$total_halaman; $i++){
                                    if($halaman == $i){
                                        echo "<li class='page-item active'><a class='page-link' href='admin.php?halaman=$i'>$i</a></li>";
                                    }else{
