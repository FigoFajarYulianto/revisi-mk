        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable">
                    ...
                    <?php
                            // Query
                            $sql = "SELECT * from transaksi inner join user on transaksi.user_id = user.user_id where status='menunggu kirim' order by tanggal_transaksi desc";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="konfirmasi-pengiriman.php?status=batal&id_transaksi=<?php echo $data['id_transaksi']; ?>"
