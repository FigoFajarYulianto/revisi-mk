            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable">
                    ...
                    <?php
                            ...
                            $sql = "select * from detail_transaksi inner join tb_produk on detail_transaksi.id_produk = tb_produk.id_produk inner join satuan on tb_produk.id_satuan=satuan.id_satuan where id_transaksi=$id_transaksi";
                    ...
                    <tr>
                        ...
                        <td><a
                                href="../../scripts/detail.php?id-produk=<?php echo $data['id_produk']; ?>"><?php echo $data["nama_produk"]; ?></a>
                        </td>
                        <td><?php echo $data["nama_satuan"]; ?></td>
                        <td><?php echo $data["jumlah"]; ?></td>
                        <td><?php echo $data["harga"]; ?></td>
                        <td><img src="../../produk2/produk2/assets/img/produk/<?php echo $data['gbr_produk'];?>" alt=""
                                style="width: 60px; height: 90px;"></td>
                    </tr>
                    <?php
                                $nomor++;
                            }
