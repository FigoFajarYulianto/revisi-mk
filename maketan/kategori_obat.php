...
<!-- Akhir navbar -->
    ...
    margin-right: auto; margin-bottom:20px; margin-top:150px;">
        ...
        <?php 
            ...
            $ambil1 = "SELECT * FROM tb_produk JOIN satuan ON tb_produk.id_satuan=satuan.id_satuan WHERE id_kategori LIKE '6'"; 
            ...
            $sql = "SELECT * FROM tb_produk  JOIN satuan ON tb_produk.id_satuan=satuan.id_satuan WHERE id_kategori LIKE '6' LIMIT $halaman_awal, $batas";
