...
<body style="background-color: #F3F3F3;">
  ...
  <header style="position: fixed;">
    ...
    margin-right: auto; margin-bottom:20px; margin-top:150px;">
        <?php 
            $ambil1 = "SELECT * FROM tb_produk JOIN satuan ON tb_produk.id_satuan=satuan.id_satuan WHERE id_kategori LIKE '4'"; 
            $query = mysqli_query($koneksi, $ambil1);?>
                <?php 
            // pagination
            $batas = 20;
            ...
            $sql = "SELECT * FROM tb_produk  JOIN satuan ON tb_produk.id_satuan=satuan.id_satuan WHERE id_kategori LIKE '4' LIMIT $halaman_awal, $batas";
