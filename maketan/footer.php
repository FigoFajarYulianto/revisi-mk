    ...
    <div class="footer-content">
      ...
      <div class="footer-section about">
        ...
        <div class="socials">
          ...
          <a href="https://www.facebook.com/rajih.kharissuha/"><i class="fab fa-facebook" style="padding-top: 5px;"></i></a>

          <a href="https://www.instagram.com/figo_fajar_y/?hl=en"><i class="fab fa-instagram" style="padding-top: 5px;"></i></a>  

          <a href="https://twitter.com/Rifqi_RE?s=08"><i class="fab fa-twitter" style="padding-top: 5px;"></i></a>

          <a href="https://youtube.com/channel/UCQGuoMsmuyCEyhrLQTS12XQ"><i class="fab fa-youtube" style="padding-top: 5px;"></i></a>
      ...
      <div class="footer-section contact-form">
        ...
        <form class="contact" action="" method="post">
          ...
          <input type="submit" name="submit" class="btn btn-big contact-btn" style="margin-top: -5px; color:white;" value="Send">
