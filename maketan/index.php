  ...
  <div id="carouselFull" class="carousel slide" data-ride="carousel">
       ...
       <div class="carousel-inner">
           ...
           <div class="carousel-item active">
               ...
               <img class="d-block" src="img/img_iklan/s1.jpg" alt="First slide">

               <div class="carousel-caption d-md-block">

                   <h3 style="font-size: 42px; font-weight: bold;">WELCOME TO MAKETAN</h3>

                   <p style="font-size: 24px; color: #21ddfb;"></p>
           ...
           <div class="carousel-item">
               ...
               <img class="d-block" src="img/img_iklan/pertanian3.jpg" alt="Second slide">
           ...
           <div class="carousel-item">
               ...
               <img class="d-block" src="img/img_iklan/pertanian iklan.jpg" alt="Third slide">
    ...
    margin-right: auto; margin-bottom:20px; margin-top:50px;">
        ...
        box-shadow: 0 0 30px rgba(0,0,0,0.18);">
                ...
                <img src="produk2/produk2/assets/img/produk/<?php echo $perproduk['gbr_produk'] ?>" style="width: 100%;  height:250px; display: block; border-radius: 20px 20px 0 0;" alt="las vegas">

                <div class="details">

                    <span style="color: white;"><?php echo substr($perproduk['nama_produk'], 0, 13)?></span>

                    <p><?php echo substr($perproduk['map_link'], 0, 22)?></p>
                    ...
                    <button class="col-md-4"><a href="https://bit.ly/3ooyooh" style="text-decoration:none; color: white;">Chat</a></button>
                        ...
                        <button class="col-md-4"><a href="detail.php?id=<?php echo $perproduk['id_produk']?>" style="text-decoration:none; color:black;">Detail</a></button>
