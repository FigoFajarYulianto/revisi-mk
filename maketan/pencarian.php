  ...
  <?php 
    ...
    margin-right: auto; margin-bottom:20px; margin-top:150px;">
        ...
        box-shadow: 0 0 30px rgba(0,0,0,0.18);">
                <img src="produk2/produk2/assets/img/produk/<?php echo $pencarian['gbr_produk'] ?>" style="width: 100%;  height:250px; display: block; border-radius: 20px 20px 0 0;" alt="las vegas">
                <div class="details">
                    <span style="color: white;"><?php echo substr($pencarian['nama_produk'], 0, 13)?></span>
                    <p><?php echo substr($pencarian['map_link'], 0, 22)?></p>
                    ...
                    <button class="col-md-4"><a href="https://bit.ly/3ooyooh" style="text-decoration:none; color: white;">Chat</a></button>
                        <button class="col-md-4"><a href="detail.php?id=<?php echo $pencarian['id_produk']?>" style="text-decoration:none; color:black;">Detail</a></button>
                    </div>
            </div>
        </div>
              <?php }//endforeach ?>
